...
export const Themes: Record<string, AppTheme> = {
  green: {
    light: {
      primary: '#66AA22',
      primaryLight: '#85CC3D',
      primarySurface: '#F0F8E6',
      primaryGradientStart: '#66AA22',
      primaryGradientEnd: '#66AA22',

      background: '#FFFFFF',
      surface: '#FFFFFF',
      surfaceElevated: '#F6FAEF',

      text: '#121A0C',
      textSecondary: '#8CA675',
      ...
      tabBar: '#FFFFFF',
      tabBarBorder: '#EBF2E1',
      tabIconDefault: '#C0CCA7',
      tabIconSelected: '#66AA22',
    },
    dark: {
      primary: '#8DE03D',
      primaryLight: '#A6F05E',
      primarySurface: '#192B0C',
      primaryGradientStart: '#66AA22',
      primaryGradientEnd: '#66AA22',

      background: '#0D1407',
      surface: '#141F0B',
      surfaceElevated: '#1D2E11',
